...
def get_menu_url(campus):
    ...
    try:
        ...
        url = page.xpath('//strong[contains(text(), "{}")]/following::a[1]/@href'.format(campus_id[campus]))[0]
...
def parse_pdf(f_pdf, campus):
    ...
    bbox = {'date': (415, 750, 750, 775),
            'menu_items': {(0, 'soup'): ((90, 640, 235, 700), (230, 640, 285, 700)),
                           ...
                           (0, 'meat'): ((90, 515, 235, 600), (230, 515, 285, 600)),
                           (2, 'soup'): ((90, 435, 235, 495), (230, 415, 285, 495)),
                           (2, 'vegetarian'): ((90, 385, 235, 445), (230, 385, 285, 445)),
                           (2, 'meat'): ((90, 315, 235, 395), (230, 315, 285, 395)),
                           (4, 'soup'): ((90, 235, 235, 290), (230, 210, 285, 290)),
                           (4, 'vegetarian'): ((90, 165, 235, 245), (230, 165, 285, 225)),
                           (4, 'meat'): ((90, 105, 235, 175), (230, 105, 285, 175)),
                           ...
                           (3, 'vegetarian'): ((350, 365, 485, 445), (480, 385, 555, 445)),
                           (3, 'meat'): ((350, 315, 485, 395), (480, 315, 555, 395)),
                           (None, 'grill'): ((350, 175, 485, 245), (480, 165, 555, 245)),
                           (None, 'pasta'): ((350, 105, 485, 175), (480, 105, 555, 165))}}
